...
import com.muhammadfairuzdzaki.frontend.Background;
import com.muhammadfairuzdzaki.frontend.GameManager;
import com.muhammadfairuzdzaki.frontend.Ground;
import com.muhammadfairuzdzaki.frontend.Player;
import com.muhammadfairuzdzaki.frontend.Command.Command;
import com.muhammadfairuzdzaki.frontend.Command.JetpackCommand;
import com.muhammadfairuzdzaki.frontend.factories.ObstacleFactory;
...
import com.muhammadfairuzdzaki.frontend.Strategies.EasyDifficultyStrategy;
import com.muhammadfairuzdzaki.frontend.Strategies.HardDifficultyStrategy;
import com.muhammadfairuzdzaki.frontend.Strategies.MediumDifficultyStrategy;

public class PlayingState implements GameState {
    private final GameStateManager gsm;
    private final ShapeRenderer shapeRenderer;
    private SpriteBatch spriteBatch; // Local batch as per Module instructions
    ...
    private void updateDifficulty(int score) {
        if (score > 2000 && !(difficultyStrategy instanceof HardDifficultyStrategy)) {
            ...
            && !(difficultyStrategy instanceof HardDifficultyStrategy)) {
    ...
    public void render(SpriteBatch batch) {
        ...
        shapeRenderer.end();
        scoreUIObserver.render(spriteBatch, GameManager.getInstance().getScore());
    }
    ...
    private void spawnObstacle() {
        ...
        float spawnAfterLastObstacle = lastObstacleSpawnX + difficultyStrategy.getMiniGap();
