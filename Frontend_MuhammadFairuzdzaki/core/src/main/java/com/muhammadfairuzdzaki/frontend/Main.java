...
import com.muhammadfairuzdzaki.frontend.Command.RestartCommand;
...
public class Main extends Game {
    ...
    private void renderGame(ShapeRenderer shapeRenderer) {
        ...
        spriteBatch.begin();
        background.render(spriteBatch, screenWidth, screenHeight);
        spriteBatch.end();
        ...
        scoreUIObserver.render(gameManager.getScore(), camera.position.x, camera.position.y, screenWidth, screenHeight);
    }
    ...
    private void checkCollisions() {
        for (BaseObstacle obstacle : obstacleFactory.getAllInUseObstacles()) {
            if (obstacle.isColliding(player.getCollider())) {
                player.die();
                return;
            }
        }
