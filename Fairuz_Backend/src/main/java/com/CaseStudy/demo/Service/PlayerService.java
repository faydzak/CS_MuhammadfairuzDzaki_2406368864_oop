...
import com.CaseStudy.demo.Player;
...
public class PlayerService {
    ...
    public void deletePlayer(UUID playerId) {
        Player player = (!playerRepository.existsById(playerId)). -> new RuntimeException("Player not found with ID: " + playerId));
     ...
     */
    public Player updatePlayerStats(UUID playerId, Integer scoreValue,
                                    Integer coinsCollected, Integer distanceTravelled)
